...
// they will be automatically recognized in prepare.initArguments
...
kdo.dir = (module, sortingRule, returnParam, lib) => {
	return exportsFn(module, sortingRule, returnParam, lib, kdo);
};
